              ...
              <tbody>
                {languageList.map((list, index) => (
                  ...
                  >
                    ...
                    <td className="p-4">{list.language}</td>
                    <td className="p-4">
                      <span className="border border-[#616161] rounded-md text-[#616161]  px-3 py-1 md:px-6 md:py-2">
                        {list.translation}
                      </span>
                    </td>
                    <td className="p-4">
                      <span
                        className={`rounded-md px-3 py-1 md:px-6 md:py-2 ${
                          list.id === 2
                    ...
                    <td className="relative p-4">
                      <BsThreeDots
                        className="h-6 w-6 text-[#707070] ml-8 cursor-pointer"
                        onClick={() => togglePopup(list.id)}
                      />
                      {activePopup === list.id && (
                        <div className="absolute right-0 top-8 bg-white flex-col justify-center items-center mr-0 sm:mr-10 inline-block py-4 px-8 rounded-lg text-[#0000009C] shadow-lg border-2 z-50">
                          <h1 className="cursor-pointer">Edit</h1>
                          <h1 className="cursor-pointer mt-2">Delete</h1>
                        </div>
                      )}
                    </td>
                  </tr>
                ...
                {languageList.map((list, index) => (
                  ...
                  >
                    ...
                    <td className="p-2 md:p-4">
                      <span className="border border-[#616161] rounded-md text-[#616161] px-2 py-1 md:px-6 md:py-2 text-xs md:text-sm">
                        {list.translation}
                      </span>
                    </td>
                    <td className="p-2 md:p-4">
