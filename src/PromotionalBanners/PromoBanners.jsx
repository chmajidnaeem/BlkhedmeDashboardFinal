...
//           </button>
//         </div>
//         <div className="flex gap-4 mt-6 font-poppins font-medium text-lg border-b-2">
//           <h1 className="border-b-2 border-black">All</h1>
//           <h1 className="text-[#707070]">Category Wise</h1>
//           <h1 className="text-[#707070]">Service Wise</h1>
//         </div>
//         <PromoTable />
//         <div className="flex justify-end mt-6">
//           <div className="bg-white justify-center items-center mr-10 inline-block py-4 px-8 rounded-lg text-[#0000009C]">
//             <h1>Edit</h1>
//             <h1>Delete</h1>
//           </div>
//         </div>
