...
//           <div className="flex flex-col bg-[#0085FF] text-white px-4 pr-14 py-2 rounded-md">
//             <h1 className="font-medium">$700.00</h1>
//             <p className="text-sm">Premium Plan</p>
//           </div>
//           <div className="flex flex-col bg-[#007C1B] text-white px-4 pr-14 py-2 rounded-md">
//             <h1 className="font-medium">$700.00</h1>
//             <p className="text-sm">Premium Plan</p>
//           </div>
//           <div className="flex flex-col bg-[#BC0000] text-white px-4 pr-14 py-2 rounded-md">
//             <h1 className="font-medium">$700.00</h1>
//             <p className="text-sm">Premium Plan</p>
//           </div>
//         </div>
